...
#define M_seal_CONCATENATE_STRINGS( p_functionName, p_error_none, p_error_pIsNULL, p_error_concatenatedStringTooLong, p_printErrorsTo )          \
  ...
  {                                                                                                                                              \
    ...
    if( p == NULL )                                                                                                                              \
    {                                                                                                                                            \
      if( p_printErrorsTo != NULL )                                                                                                              \
        fprintf( p_printErrorsTo, #p_functionName " - p == NULL.\n" );                                                                           \
      p_error_pIsNULL                                                                                                                            \
    ...
    {                                                                                                                                            \
      ...
      {                                                                                                                                          \
        if( p_printErrorsTo != NULL )                                                                                                            \
          fprintf( p_printErrorsTo, #p_functionName " - the length of the concatenated string exceeds 2^(sizeof( size_t )*8)-2 characters.\n" ); \
